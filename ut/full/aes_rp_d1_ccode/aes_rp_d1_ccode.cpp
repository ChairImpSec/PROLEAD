...
TEST_CASE("Test full verification (aes_rp_d1_ccode)", "[aes_rp_d1_ccode]") {
  ...
  vm.insert(
      {"designfile",
       po::variable_value{
           std::string("ut/full/aes_rp_d1_ccode/aes_rp_d1_ccode_c.c"), false}});
  vm.insert(
      {"configfile",
       po::variable_value{
           std::string("ut/full/aes_rp_d1_ccode/aes_rp_d1_ccode.json"), false}});
  vm.insert(
      {"resultfolder",
       po::variable_value{std::string("ut/full/aes_rp_d1_ccode/"), false}});
  vm.insert(
      {"linkerfile",
       po::variable_value{
           std::string("ut/full/aes_rp_d1_ccode/aes_rp_d1_ccode.ld"), false}});
  vm.insert(
      {"binary",
       po::variable_value{
           std::string("ut/full/aes_rp_d1_ccode/aes_rp_d1_ccode.elf"), false}});
  vm.insert(
      {"mapfile",
       po::variable_value{
           std::string("ut/full/aes_rp_d1_ccode/aes_rp_d1_ccode.map"), false}});
  vm.insert(
      {"asmfile",
       po::variable_value{
           std::string("ut/full/aes_rp_d1_ccode/aes_rp_d1_ccode.txt"), false}});
  ...
  Read::SettingsFile(settings_file_path, settings, settings2, probes, false);
