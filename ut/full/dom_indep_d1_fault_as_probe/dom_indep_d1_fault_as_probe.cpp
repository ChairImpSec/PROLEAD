...
Test TestDomIndepd1FaultAsProbe(Settings& settings) {
  ...
  const std::string design_file_name =
      "ut/full/dom_indep_d1_fault_as_probe/dom_indep_d1_fault_as_probe.v";
  const std::string topmodule_name = "dom_indep_d1_fault_as_probe";
  const std::string result_folder_name = "ut/full/dom_indep_d1_fault_as_probe";
...
TEST_CASE("Test full verification (dom_indep_d1_fault_as_probe)",
  ...
  const std::string config_file_name =
      "ut/full/dom_indep_d1_fault_as_probe/dom_indep_d1_fault_as_probe.json";
