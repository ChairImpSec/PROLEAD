...
Test TestDomIndepd1Extension(Settings& settings) {
  ...
  const std::string design_file_name =
      "ut/full/dom_indep_d1_extension/dom_indep_d1_extension.v";
  const std::string topmodule_name = "dom_indep_d1_extension";
  const std::string result_folder_name = "ut/full/dom_indep_d1_extension";
...
TEST_CASE("Test full verification (dom_indep_d1_extension)",
  ...
  const std::string config_file_name =
      "ut/full/dom_indep_d1_extension/dom_indep_d1_extension.json";
