...
TEST_CASE("Test full verification (aes_rp_d1_binary)", "[aes_rp_d1_binary]") {
  ...
  vm.insert({"designfile",
             po::variable_value{
                 std::string("ut/full/aes_rp_d1_binary/aes_rp_d1_binary_c.c"),
                 false}});
  vm.insert({"configfile",
             po::variable_value{
                 std::string("ut/full/aes_rp_d1_binary/aes_rp_d1_binary.json"),
                 false}});
  vm.insert(
      {"resultfolder",
       po::variable_value{std::string("ut/full/aes_rp_d1_binary/"), false}});
  vm.insert({"linkerfile",
             po::variable_value{
                 std::string("ut/full/aes_rp_d1_binary/aes_rp_d1_binary.ld"),
                 false}});
  vm.insert({"binary",
             po::variable_value{
                 std::string("ut/full/aes_rp_d1_binary/aes_rp_d1_binary.elf"),
                 false}});
  vm.insert({"mapfile",
             po::variable_value{
                 std::string("ut/full/aes_rp_d1_binary/aes_rp_d1_binary.map"),
                 false}});
  vm.insert({"asmfile",
             po::variable_value{
                 std::string("ut/full/aes_rp_d1_binary/aes_rp_d1_binary.txt"),
                 false}});
  ...
  Read::SettingsFile(settings_file_path, settings, settings2, probes, true);
