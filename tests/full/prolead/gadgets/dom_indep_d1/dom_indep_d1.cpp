...
void RunDomIndepD1(const std::string& configfile, const std::string& expected_probe_report_name) {
    std::string path = "tests/full/prolead/gadgets/dom_indep_d1/";
    po::variables_map vm;
...
bool CheckDomIndepD1(bool expected_leakage) {
  std::string leakage_report_name = 
    "tests/full/prolead/gadgets/dom_indep_d1/prolead_dom_indep_d1_0_0_16384_leakages.json";
